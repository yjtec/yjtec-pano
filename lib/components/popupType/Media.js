...
function (_React$Component) {
  ...
  _createClass(ActionMedia, [{
    ...
    value: function componentDidMount() {
      ...
      if ((0, _yjtecSupport.isArray)(data) && !_yjtecSupport.Arr.isNull(data)) {
        this.setState({
          list: data
        });
      }
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      if (!_yjtecSupport.Obj.isEqual(this.state.list, nextState.list)) {
        var onChange = this.props.onChange;
        if (onChange) onChange(nextState.list);
      }

      if (!_yjtecSupport.Obj.isEqual(this.props.data, nextProps.data)) {
        this.setState({
          list: nextProps.data
        });
      }
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("p", null, "\u76F8\u518C", _react.default.createElement(_button.default, {
        ...
        type: "primary",
        size: "small"
      }, "\u9009\u62E9\u56FE\u7247")), _react.default.createElement(_MediaModal.default, {
        title: "\u56FE\u7247\u7D20\u6750\u5E93",
        mediaType: 1,
        tabType: 1,
      ...
      }), _react.default.createElement(_PicList.default, _extends({
        data: list,
        onDel: this.delImg,
