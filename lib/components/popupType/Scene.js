...
var Scene = (_dec = (0, _dva.connect)(function (_ref) {
...
function (_React$Component) {
  ...
  _createClass(Scene, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", {
      ...
      }, _react.default.createElement(_row.default, null, scene.map(function (item) {
        return _react.default.createElement(_col.default, {
          ...
          alt: "img",
          src: (0, _oss.panoImgConfig)(item.thumb.path),
          style: {
            width: '100%',
            height: '62px',
