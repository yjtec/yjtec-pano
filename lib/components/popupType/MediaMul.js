...
function (_React$Component) {
  ...
  _createClass(MediaMul, [{
    ...
    value: function componentDidMount() {
      ...
      if ((0, _yjtecSupport.isArray)(data) && data.length > 0) {
        this.setState({
          list: data
        });
      }
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      ...
      if (!_yjtecSupport.Obj.isEqual(nextState.list, this.state.list) && !_yjtecSupport.Obj.isEqual(nextState.list, nextProps.data)) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_Media.default, {
        activeId: activeId,
        data: list,
        onChange: this.handleChange,
        onClick: this.handleClick
      }), _react.default.createElement("div", {
        className: _style2.default.mb10
      }), current && _react.default.createElement("div", null, _react.default.createElement("p", null, "\u6587\u5B57\u5185\u5BB9", _react.default.createElement("a", {
      ...
      }, "\u5E94\u7528\u5230\u6240\u6709")), _react.default.createElement("div", {
        className: _style2.default.textAreaDiv
