...
function (_Component) {
  ...
  _createClass(InitialSceneEdit, [{
    ...
    value: function render() {
      ...
      }, scene.length > 0 ? _react.default.createElement("div", null, _react.default.createElement("img", {
        src: scene[0].thumb.url,
        alt: scene[0].name
      }), _react.default.createElement("p", null, scene[0].name)) : _react.default.createElement("span", null, "\u8BF7\u9009\u62E9\u573A\u666F"), _react.default.createElement("div", {
        style: {
          clear: 'both'
        }
      }))), _react.default.createElement("div", {
