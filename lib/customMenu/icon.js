  ...
  _createClass(icon, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: _style.default.menu_icon
      }, _react.default.createElement("img", {
        src: (0, _oss.mediaImgConfig)(url ? url : '', 'img'),
        alt: "\u56FE\u6807"
      ...
      }, "\u5EFA\u8BAE\u5C3A\u5BF8", _react.default.createElement("br", null), "100X100"), _react.default.createElement("div", {
        className: _style.default.menu_icon_btn,
        onClick: function onClick() {
          return _this2.openMediaModal();
        }
      }, "\u7F16\u8F91\u56FE\u6807"), _react.default.createElement("div", {
        style: {
          clear: 'both'
        }
