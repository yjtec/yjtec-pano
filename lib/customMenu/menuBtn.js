...
function (_React$Component) {
  ...
  _createClass(MenuBtn, [{
    ...
    value: function render() {
      ...
      }, data.type == 1 && _react.default.createElement(_popupType.default.Url, _extends({}, data.action_data, {
        onChange: function onChange(e) {
          return _this2.handleData(e, 'url');
        }
      })), data.type == 2 && _react.default.createElement(_popupType.default.Phone, {
        phone: data.action_data,
        onChange: function onChange(e) {
          return _this2.handleData(e, 'phone');
        }
      }), data.type == 3 && _react.default.createElement(_location.default.Bmap, {
        help: 'location',
        title: '导航标注',
      ...
      }), data.type == 4 && _react.default.createElement(_popupType.default.MediaMul, {
        data: data.action_data,
        onChange: function onChange(e) {
          return _this2.handleData(e, 'mediamul');
        }
      }), data.type == 5 && _react.default.createElement(_popupType.default.Video, {
        data: data.action_data,
        onChange: function onChange(e) {
          return _this2.handleData(e, 'video');
        }
      }), data.type == 6 && _react.default.createElement(_popupType.default.Rings, {
        data: data.action_data,
        onChange: function onChange(e) {
          return _this2.handleData(e, 'rings');
        }
      }), data.type == 7 && _react.default.createElement(_popupType.default.Model, {
        data: data.action_data,
        onChange: function onChange(e) {
          return _this2.handleData(e, 'model');
        }
      }), data.type == 8 && _react.default.createElement(_popupType.default.RichText, {
        data: data.action_data,
        onChange: function onChange(e) {
