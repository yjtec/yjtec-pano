  ...
  _createClass(FineTuning, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        className: _style3.default.spacing
      }), this.props.embedType == 4 && this.state.editType == 2 && align, (this.props.embedType == 2 || this.props.embedType == 3 || this.state.editType == 1) && trim, _react.default.createElement("div", {
        className: _style3.default.spacing
      }), _react.default.createElement("div", {
        className: "".concat(_style3.default.box, " ").concat(_style3.default.bg),
        style: {
