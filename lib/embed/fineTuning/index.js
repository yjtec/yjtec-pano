...
function (_React$Component) {
  ...
  _createClass(FineTuning, [{
    ...
    value: function render() {
      ...
      }, this.props.embedType == 4 ? _react.default.createElement("span", {
        className: "".concat(this.state.editType == 2 && _style3.default.seleased),
        onClick: function onClick() {
          return _this3.switch(2);
        }
      }, "\u4F4D\u7F6E\u5BF9\u9F50") : _react.default.createElement("span", {
        className: "".concat(this.state.editType == 1 && _style3.default.seleased)
      }, "\u7EC6\u8282\u8C03\u6574")), _react.default.createElement("div", {
        className: _style3.default.spacing
      }), this.props.embedType == 4 && align, (this.props.embedType == 2 || this.props.embedType == 3 || this.state.editType == 1) && trim, _react.default.createElement("div", {
        className: _style3.default.spacing
      }), _react.default.createElement("div", {
        className: "".concat(_style3.default.box, " ").concat(_style3.default.bg),
        style: {
