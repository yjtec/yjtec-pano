    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          ...
          alt: "\u56FE\u7247",
          src: (0, _oss.ossImgMedia)(item.actionData.img[0].url, 'media')
        }), item.type == 3 && _react.default.createElement("img", {
          alt: "\u5E8F\u5217\u56FE",
          src: (0, _oss.ossImgMedia)(item.actionData.url, 'media')
        }), item.type == 4 && _react.default.createElement("img", {
          alt: "\u89C6\u9891",
          src: (0, _oss.ossImgMedia)(item.actionData.thumbUrl, 'media')
        })), _react.default.createElement("div", {
