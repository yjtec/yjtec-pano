...
function (_Component) {
  ...
  _createClass(EmbedAdd, [{
    ...
    value: function render() {
      ...
      var saveDiv = _react.default.createElement(_components.ItemBox, null, _react.default.createElement(_row.default, {
        style: {
          margin: '0 -5px'
        }
      ...
      }), embedType == 4 && isVip == 1 || embedType == 1 || embedType == 2 || embedType == 3 ? saveDiv : ''), _react.default.createElement(_fineTuning.default, {
        visible: this.props.visible,
