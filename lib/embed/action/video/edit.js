...
function (_React$Component) {
  ...
  function Edit(props) {
    ...
    _this.handleVideoMedia = function (url, name) {
      if (!_yjtecSupport.Obj.isNull(url)) {
        _this.setState({
          videoUrl: url,
          title: name,
          videoVisible: false
  ...
  _createClass(Edit, [{
    ...
    value: function render() {
      ...
      var thumbBox = _react.default.createElement("div", null, _react.default.createElement("img", {
        alt: "url",
        src: (0, _oss.ossImgMedia)(thumbUrl, 'media'),
        className: _style4.default.imgss
      ...
      return _react.default.createElement("div", {
        ...
        className: _style4.default.boxtitle
      }, "\u89C6\u9891\u5BBD\u9AD8"), _react.default.createElement("div", {
        style: {
          marginBottom: '10px'
        }
      ...
      }, "\u662F\u5426")), "\u81EA\u52A8\u64AD\u653E(PC\u6709\u6548)"), _react.default.createElement("div", {
        className: _style4.default.title,
        style: {
          marginTop: 10
        }
        ...
        className: _style4.default.checkbox
      }, "\u662F\u5426")), "\u5FAA\u73AF\u64AD\u653E")), _react.default.createElement(_Media.default, {
        title: "\u89C6\u9891",
